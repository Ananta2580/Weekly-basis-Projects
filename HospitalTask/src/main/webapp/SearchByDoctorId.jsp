...
<body>
    ...
    <div class="navbar-custom d-flex align-items-center justify-content-between">
        ...
        <div>
            ...
            <a class="nav-link d-inline" href="SearchByDoctorId.jsf">Search</a>
    ...
    <div class="container">
        <h:form>
            <div class="form-group row">
                <label for="specialization" class="col-sm-2 col-form-label">Doctor Id:</label>
                <div class="col-sm-6">
                    <h:inputText id="specialization" value="#{doctor.doctorId}" styleClass="form-control"/>
                </div>
                <div class="col-sm-2">
                    <h:commandButton value="Show" action="#{hospitalController.searchByDoctorId(doctor.doctorId)}" styleClass="btn btn-custom"/>
                </div>
            </div>

            <c:set var="doc" value="#{hospitalController.searchByDoctorId(doctor.doctorId)}" />
