...
<body>
    ...
    <!-- Table -->
    <h:form>
        <h:dataTable value="#{hospitalController.showMedicalHistory()}" var="hist" styleClass="doctor-table" border="0">

            <h:column>
                <f:facet name="header">
                    <h:outputText value="Medication ID" />
                </f:facet>
                <h:outputText value="#{hist.medId }" />
            </h:column>
            ...
            <h:column>
                ...
                <h:outputText value="#{hist.patientId }" />
            </h:column>
            ...
            <h:column>
                ...
                <h:outputText value="#{hist.medicines}" />
            </h:column>
