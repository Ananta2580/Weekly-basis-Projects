    ...
    <div class="container">
        <h:form>
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <h:inputText id="patientId" value="#{patient.patientId}" styleClass="form-control"/>
                </div>
                <div class="col-sm-2">
                    <h:commandButton value="Show" action="#{hospitalController.searchById(patient.patientId)}" styleClass="btn btn-custom"/>
                </div>
            </div>

            <c:set var="patient" value="#{hospitalController.searchById(patient.patientId)}" />

<c:if test="${not empty patient}">
    <div class="doctor-card">
        <p><strong>Patient ID:</strong> <h:outputText value="#{patient.patientId}" /></p>
        <p><strong>Name:</strong> <h:outputText value="#{patient.patientName}" /></p>
        <p><strong>DoctorId:</strong> <h:outputText value="#{patient.doctorId}" /></p>
        <p><strong>DOB:</strong> <h:outputText value="#{patient.dateOfBirth}" /></p>
